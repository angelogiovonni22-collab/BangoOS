...
-- This migration intentionally records deletion requests without automatically
-- deleting authentication or tenant records. Final deletion processing remains
-- subject to identity verification and legitimate retention obligations.
