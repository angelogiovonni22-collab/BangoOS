...
export function EstimateLineItemsSection({ lineItems, localeTag, error, onChange }: { lineItems: EstimateLineItemDraft[]; localeTag: string; error?: string; onChange: (lineItems: EstimateLineItemDraft[]) => void; }) {
