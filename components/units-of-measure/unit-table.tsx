...
export function UnitTable({ items, total, page, pageSize, onPageChange }: UnitTableProps) {
  ...
  return (
    <TableContainer title={l("Unit Directory", "Directorio de unidades")} description={l("Centralized system and company unit library.", "Biblioteca centralizada de unidades del sistema y de la empresa.")}>
