...
export function ProjectTabs({ activeTab, onChange, t }: ProjectTabsProps) {
  ...
  return (
    ...
    >
      <nav className="flex min-w-0 items-center gap-1.5 overflow-x-auto pb-0.5 xl:flex-wrap xl:overflow-visible" aria-label={t("projects.workspaceNavigationLabel")}>
        {items.map((item) => {
