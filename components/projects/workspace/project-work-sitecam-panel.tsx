      ...
      <CardContent className="space-y-4 p-5">
        ...
        <div className="rounded-[12px] border border-[var(--color-border-subtle)] bg-[var(--color-surface-subtle)]/55 p-3">
          ...
          <div className="flex flex-wrap items-center gap-2">
            ...
            <Button type="button" size="sm" className="bg-[#2378ea] font-bold text-white hover:bg-[#1767d1] disabled:bg-[#7aaee8] disabled:text-white" disabled={isUploading || uploadQueue.length === 0} onClick={() => void uploadPhotos()}>
