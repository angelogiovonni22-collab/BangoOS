...
const linkedTabs = ["daily_logs", "documents", "crew", "change_orders", "rfis", "submittals"];
...
test("linked project workspace reads project-scoped operational data", () => {
  ...
  assert(linkedModule.includes('from("project_submittals")'), "Submittals should read project submittals");
