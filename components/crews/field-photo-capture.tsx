...
export function FieldPhotoCapture({ projectId, projectName, onUploaded }: { projectId: string; projectName: string; onUploaded: () => Promise<void> }) {
  ...
  const upload = async () => {
    ...
    setFile(null); setNote(""); setMessage("Field photo uploaded."); setBusy(false); await onUploaded();
  };
