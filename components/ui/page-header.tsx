...
export function PageHeader({ eyebrow = "B.O.S.", title, description, primaryAction, secondaryActions, compact = false }: PageHeaderProps) {
  return (
    <section data-bos-page-header="true" className={`relative flex min-w-0 flex-col overflow-hidden border border-[var(--color-border-subtle)] ${compact ? "gap-3.5 px-5 py-4" : "gap-5 px-5 py-5 sm:px-6 sm:py-6"} sm:flex-row sm:items-end sm:justify-between`}>
