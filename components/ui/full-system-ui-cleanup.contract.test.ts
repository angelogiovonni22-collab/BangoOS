...
const projectHeader = readFileSync("components/projects/workspace/project-workspace-header.tsx", "utf8");
const projectWeather = readFileSync("components/projects/workspace/project-header-weather-strip.tsx", "utf8");
