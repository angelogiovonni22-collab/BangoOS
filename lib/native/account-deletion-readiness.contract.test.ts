...
const migration = read("supabase/migrations/20260907050000_user_account_deletion_requests.sql");
...
assert.match(publicPage, /Request account deletion/, "A public web deletion resource must exist for store review");
