...
export const constructionAgreementSections: ConstructionAgreementSection[] = [
  ...
  },
  {
    ...
    paragraphs: [
      "Owner acknowledges that Contractor invests substantial time, expense, management effort, recruiting resources, training, supervision, estimating, scheduling, project coordination, and relationship-building in its employees, subcontractors, crews, vendors, suppliers, and trade partners. For this Section, Protected Personnel means any employee, superintendent, project manager, estimator, laborer, crew member, independent contractor, subcontractor, lower-tier subcontractor, consultant, vendor, supplier, or trade partner who performs services in connection with the Project, is introduced to Owner through Contractor, or becomes known to Owner because of Contractor's involvement in the Project.",
      "During the term of this Agreement and for twelve (12) months following the later of substantial completion, termination, cancellation, or the last material performance of work on the Project, Owner shall not knowingly, directly or indirectly, solicit, recruit, induce, encourage, hire, retain, contract with, employ, or otherwise engage Protected Personnel for the purpose of bypassing, replacing, circumventing, or interfering with Contractor's relationship with that person or entity in connection with the Project or a substantially related opportunity.",
