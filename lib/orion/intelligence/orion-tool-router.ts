...
export function buildOrionSystemPolicy() {
  return [
    ...
    "Current-context rule: when the user says this project, this job, this page, the project I have open, or otherwise refers to the currently visible BOS record, first use the available current-context capability before asking for a project or record name. If current context returns an active project and project details, use those details directly and do not ask the user to identify the project again.",
