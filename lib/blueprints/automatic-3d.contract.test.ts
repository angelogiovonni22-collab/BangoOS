...
assert(raster.includes("renderBlueprintPdfPage") && raster.includes("@napi-rs/canvas"), "Raster fallback must render the selected PDF page through the pdfjs Node canvas path before Sharp line extraction");
