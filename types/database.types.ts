  ...
  public: {
    Tables: {
      ...
      bos_intelligence_usage_ledger: {
        Row: { actor_user_id: string | null; company_id: string; correlation_id: string | null; created_at: string; credit_delta: number; currency: string; customer_charge_cents: number; entry_type: string; id: string; idempotency_key: string; metadata: Json; product: string; provider_cost_micros: number; quantity: number; source_id: string | null; source_type: string | null }
        Insert: { actor_user_id?: string | null; company_id: string; correlation_id?: string | null; created_at?: string; credit_delta: number; currency?: string; customer_charge_cents?: number; entry_type: string; id?: string; idempotency_key: string; metadata?: Json; product: string; provider_cost_micros?: number; quantity?: number; source_id?: string | null; source_type?: string | null }
        Update: { actor_user_id?: string | null; company_id?: string; correlation_id?: string | null; created_at?: string; credit_delta?: number; currency?: string; customer_charge_cents?: number; entry_type?: string; id?: string; idempotency_key?: string; metadata?: Json; product?: string; provider_cost_micros?: number; quantity?: number; source_id?: string | null; source_type?: string | null }
        Relationships: [
          { foreignKeyName: "bos_intelligence_usage_ledger_actor_user_id_fkey"; columns: ["actor_user_id"]; isOneToOne: false; referencedRelation: "profiles"; referencedColumns: ["id"] },
          { foreignKeyName: "bos_intelligence_usage_ledger_company_id_fkey"; columns: ["company_id"]; isOneToOne: false; referencedRelation: "companies"; referencedColumns: ["id"] },
        ]
      }
      bos_tenant_accounts: {
        Row: { billing_customer_ref: string | null; billing_interval: string | null; blueprint_intelligence_allowance: number; cancel_at_period_end: boolean; company_id: string; created_at: string; current_period_end: string | null; intelligence_internal_non_billable: boolean; intelligence_price_per_credit_cents: number; intelligence_spending_limit_cents: number | null; internal_notes: string | null; last_payment_at: string | null; last_webhook_event_at: string | null; lifecycle_status: string; onboarding_state: Json; orion_text_allowance: number; orion_voice_minutes: number; payment_method_status: string | null; plan_key: string; seat_limit: number; stripe_customer_id: string | null; stripe_price_id: string | null; stripe_product_id: string | null; stripe_subscription_id: string | null; subscription_ref: string | null; subscription_status: string | null; support_tier: string; trial_ends_at: string | null; updated_at: string }
        Insert: { billing_customer_ref?: string | null; billing_interval?: string | null; blueprint_intelligence_allowance?: number; cancel_at_period_end?: boolean; company_id: string; created_at?: string; current_period_end?: string | null; intelligence_internal_non_billable?: boolean; intelligence_price_per_credit_cents?: number; intelligence_spending_limit_cents?: number | null; internal_notes?: string | null; last_payment_at?: string | null; last_webhook_event_at?: string | null; lifecycle_status?: string; onboarding_state?: Json; orion_text_allowance?: number; orion_voice_minutes?: number; payment_method_status?: string | null; plan_key?: string; seat_limit?: number; stripe_customer_id?: string | null; stripe_price_id?: string | null; stripe_product_id?: string | null; stripe_subscription_id?: string | null; subscription_ref?: string | null; subscription_status?: string | null; support_tier?: string; trial_ends_at?: string | null; updated_at?: string }
        Update: { billing_customer_ref?: string | null; billing_interval?: string | null; blueprint_intelligence_allowance?: number; cancel_at_period_end?: boolean; company_id?: string; created_at?: string; current_period_end?: string | null; intelligence_internal_non_billable?: boolean; intelligence_price_per_credit_cents?: number; intelligence_spending_limit_cents?: number | null; internal_notes?: string | null; last_payment_at?: string | null; last_webhook_event_at?: string | null; lifecycle_status?: string; onboarding_state?: Json; orion_text_allowance?: number; orion_voice_minutes?: number; payment_method_status?: string | null; plan_key?: string; seat_limit?: number; stripe_customer_id?: string | null; stripe_price_id?: string | null; stripe_product_id?: string | null; stripe_subscription_id?: string | null; subscription_ref?: string | null; subscription_status?: string | null; support_tier?: string; trial_ends_at?: string | null; updated_at?: string }
