...
export function InventoryWorkspaceClient() {
  ...
  return (
    <div className="container-content space-y-[var(--space-section)]">
      <PageHeader eyebrow="Resources · Inventory" title="Inventory & Warehouse Command Center" description="Live stock, reservations, locations, movement history, and replenishment intelligence across B.O.S." primaryAction={<div className="flex flex-wrap gap-2"><Link href="/materials/procurement"><Button>Receive Materials</Button></Link><Link href="/materials"><Button variant="outline">Material Catalog</Button></Link></div>} />
