...
export default function InvoicesPage() {
  ...
  return <div className="container-content space-y-[var(--space-section)]">
    ...
    <div className="grid gap-3 md:grid-cols-2 xl:grid-cols-5">
      ...
      <Link href="/invoices/banking" className={workspaceCard}><p className="text-xs font-bold uppercase tracking-[0.16em] text-[var(--bos-text-muted)]">Finance</p><div className="mt-2 flex items-center justify-between gap-4"><div><h2 className="text-lg font-semibold">Banking</h2><p className="mt-1 text-sm text-[var(--bos-text-secondary)]">Bank feeds, reconciliation, transaction matching, and cash forecasting.</p></div><span className="text-xl text-blue-400 transition group-hover:translate-x-1">→</span></div></Link>
