...
async function executeCanonicalCommand(args: {
  ...
  // Do not trust the role carried by the API context/cache as the final authority.
  // Re-read the active membership immediately before every executable Orion command
  // and apply semantic B.O.S. module permissions (including explicit overrides).
