...
export default function EstimateContractPage({ params }: { params: Promise<{ token: string }> }) {
  ...
  if (signed) return <main className="mx-auto max-w-3xl p-6"><div className="rounded-3xl border border-emerald-200 bg-emerald-50 p-8"><h1 className="text-2xl font-bold text-emerald-950">Estimate signed</h1><p className="mt-3 text-emerald-800">Your estimate has been accepted and BOS has created the project. You may close this page.</p></div></main>;
